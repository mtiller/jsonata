...
export interface Visitor {
    ...
    enterBinaryObject?: (node: ast.GroupedObjectNode) => void;
    exitBinaryObject?: (node: ast.GroupedObjectNode) => void;
    enterSort?: (node: ast.GroupedObjectNode) => void;
    exitSort?: (node: ast.GroupedObjectNode) => void;
