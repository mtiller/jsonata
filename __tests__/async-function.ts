...
describe.skip("Invoke JSONata with callback", function() {
    describe.skip("Make HTTP request", function() {
        it("should return promise to results", async () => {
            var expr = jsonata(
                '$httpget("https://api.npmjs.org/downloads/range/2016-09-01:2017-03-31/jsonata").downloads{ $substring(day, 0, 7): $sum(downloads) }',
            );
...
describe.skip("Invoke JSONata with callback - errors", function() {
    describe.skip("type error", function() {
        it("should throw", async () => {
            var expr = jsonata(
                '5 + $httpget("htttttps://api.npmjs.org/downloads/range/2016-09-01:2017-03-31/jsonata")',
            );
            expr.assign("httpget", httpget);
    ...
    describe.skip("Make HTTP request with dodgy url", function() {
        it("should throw", async () => {
            var expr = jsonata(
                '$httpget("htttttps://api.npmjs.org/downloads/range/2016-09-01:2017-03-31/jsonata").downloads{ $substring(day, 0, 7): $sum(downloads) }',
            );
            expr.assign("httpget", httpget);
            try {
                await jsonataPromise(expr);
...
describe.skip("Invoke JSONata with callback - return values", function() {
...
describe.skip("Handle chained functions that end in promises", function() {
